...
<div class="box">
    ...
    <div class="choice-box">
        <label>性别</label>
        <div><input type="radio" name="sex" value="男" id="maleRadio" /><span>男</span></div>
        <div><input type="radio" name="sex" value="女" id="femaleRadio"/><span>女</span></div>
        <div><input type="radio" name="sex" value="无" id="noSexRadio" checked/><span>无</span></div>

    </div>
    <div class="choice-box">
        <label>类型</label>
        <div><input type="radio" name="type" value="1" id="userRadio" checked/><span>普通</span></div>
        <div><input type="radio" name="type" value="0" id="adminRadio"/><span>管理员</span></div>
    </div>
    <div class="btn-box">
        <div>
