...
<body>
<%
    String userBeanJson = (String) request.getAttribute("userBean");
    Gson gson = new Gson();
    UserBean userBean = gson.fromJson(userBeanJson,UserBean.class);
%>
<div class="box">
    <h2>Modify User</h2>
    <div class="input-box">
    ...
    <div class="choice-box">
        <label>类型</label>
        <div><input type="radio" name="type" value="1" id="userRadio" <%= userBean.getType()==1 ? "checked":""%>/><span>普通</span></div>
        <div><input type="radio" name="type" value="0" id="adminRadio"<%= userBean.getType()==0 ? "checked":""%>/><span>管理员</span></div>
    </div>
    <div class="btn-box">
        <div>
